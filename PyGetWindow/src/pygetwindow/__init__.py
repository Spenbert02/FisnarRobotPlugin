...
import sys, collections, os, importlib

plugin_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
pyrect_path = os.path.join(plugin_dir, "PyRect", "pyrect", "__init__.py")
spec_5 = importlib.util.spec_from_file_location("pyrect", pyrect_path)
pyrect_module = importlib.util.module_from_spec(spec_5)
sys.modules["pyrect"] = pyrect_module
spec_5.loader.exec_module(pyrect_module)
import pyrect
