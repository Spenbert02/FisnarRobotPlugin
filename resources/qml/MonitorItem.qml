        ...
        Rectangle
        {
                  ...
                  Rectangle {
                    ...
                    Column {  // column for pick and place entries; TODO: these text box values should be able to be updated from python
                      ...
                      Row {  // serial port entry
                        ...
                        TextField {
                          id: dispenserSerialPort
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control").height
                          text: "<port>"  // TODO: should pull from OutputDevice
                          onEditingFinished: {}  // TODO: should update value in FisnarOutputDevice
                        }
                      }
                      ...
                      Rectangle {  // pick location
                        ...
                        UM.Label {  // x label
                          ...
                          font: UM.Theme.getFont("default_bold")
                          height: UM.Theme.getSize("setting_control").height
                          anchors.left: pickLocLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                          anchors.top: parent.top
                        }
                        ...
                        TextField {  // x entry
                          id: pickXEntry
                          anchors.left: pickXLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                          anchors.top: parent.top
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control").height
                          text: "123.456"  // TODO: should pull from preferences in plugin
                          ...
                          onEditingFinished: {}  // TODO: should update value in plugin
                        }
                        ...
                        TextField {  // pick y entry
                          ...
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control").height
                          text: "123.456"  // TODO: should pull value from plugin
                          validator: DoubleValidator {
                            decimals: 3
                            locale: "en_US"
                            bottom: 0
                          ...
                          onEditingFinished: {}  // TODO: this should update value in plugin
                        }
                        ...
                        TextField {  // z entry
                          ...
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control").height
                          text: "123.456"  // TODO: this should pull from preferences
                          validator: DoubleValidator {
                            decimals: 3
                            locale: "en_US"
                            bottom: 0
                      ...
                      Rectangle {  // place location
                        ...
                        UM.Label {  // place x label
                          ...
                          height: UM.Theme.getSize("setting_control").height
                          anchors.top: parent.top
                          anchors.left: placeLocLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                        }
                        ...
                        TextField {  // place x entry
                          id: placeXEntry
                          anchors.top: parent.top
                          anchors.left: placeXLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").height
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control").height
                          text: "654.321"  // TODO: this should pull from plugin
                          validator: DoubleValidator {
                            decimals: 3
                            locale: "en_US"
                            bottom: 0
                      ...
                      Rectangle {  // vacuum pressure
                        ...
                        TextField {
                          ...
                          anchors.left: vacuumPressureLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                          anchors.top: parent.top
                          text: "123.123"
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control")
                          onEditingFinished: {}  // TODO
                        }
                        ...
                        ComboBox {
                          ...
                          height: UM.Theme.getSize("setting_control").height
                          anchors.left: vacuumPressureEntry.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                          anchors.top: parent.top
                      ...
                      Rectangle {  // movement speed
                        ...
                        UM.Label {
                          ...
                          font: UM.Theme.getFont("default_bold")
                          height: UM.Theme.getSize("setting_control").height
                          anchors.left: movementSpeedLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                          anchors.top: parent.top
                        }
                        ...
                        TextField {
                          id: xySpeedEntry
                          text: "987.654"  // TODO
                          anchors.left: xySpeedLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
                          anchors.top: parent.top
                          width: UM.Theme.getSize("setting_control").width
                          height: UM.Theme.getSize("setting_control").height
                        ...
                        UM.Label {
                          ...
                          font: UM.Theme.getFont("default_bold")
                          height: UM.Theme.getSize("setting_control").height
                          anchors.left: xySpeedLabel.left
                        ...
                        TextField {
                          id: zSpeedEntry
                          text: "987.123"
                          anchors.left: zSpeedLabel.right
                          anchors.leftMargin: UM.Theme.getSize("default_margin").width
            ...
            Item {  // start of "MonitorButton"
              ...
              UM.Label {  // Progress percentage label
                ...
                text: "12.34%"  // TODO: should be dynamic - n/a if not printing, the actual printing percentage when printing
                font: UM.Theme.getFont("large_bold")
                anchors.top: parent.top
