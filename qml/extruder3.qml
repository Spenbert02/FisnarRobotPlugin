...
Grid {
  ...
  TextField
  {
    id: extruder3Output  // probably for reference within python?
    text: main.getExtruder3Output  // probably for reference somewhere, idk where
    ...
    onEditingFinished: {  // called when return or enter is pressed or when text entry box loses focus
      main.setExtruderOutput("extruder_3_output", extruder3Output.text)
    }
  }
}
