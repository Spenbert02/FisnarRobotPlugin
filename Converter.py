...
# # this will be implemented later on (inside Converter)). TODO!
...
class Converter:
    ...
    def getExtrudersInGcode(self):
        ...
        if self.gcode_commands_lst is None:
            pass  # needs to signal an error somehow (and return)
...
if __name__ == "__main__":
    ...
    c.setExtruderOutputs("one", 2, 3.0, "4")

    for i in c.getExtruderOutputs():
        print(i)
